...
public ventana2()
{
    ...
    clave.setBounds(10, 190, 80, 25);
     ...
     boton.setBounds(120, 250, 100, 25);
...
public void insertar (String dni)throws SQLException {
		String sql ="INSERT INTO persona(dni)Values(default,'"+dni+"'))";
	...
	public void actionPerformed(ActionEvent e) {
		...
		if((nom.getText().equals(""))&&(ape.getText().equals(""))&&(edad.getText().equals(""))&&(correo.getText().equals(""))&&(dir.getText().equals(""))&&(dni.getText().equals("")))
		{
